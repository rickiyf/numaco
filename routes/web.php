...
Route::post('/aplicreatew', 'Adm\AplicacionesController@store')->name('aplicreate');
...
Route::post('/trabajosrealizadosstore','Adm\TrabajosRealizController@store')->name('tracreate');
...
Route::post('/contactostore', 'Adm\ContactoController@store')->name('contactocreate') ;
